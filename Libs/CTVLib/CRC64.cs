...
namespace Helpers
{
	public class CRC64
	{
		...
		public static UInt64 Compute(byte[] s, UInt64 crc = 0)
		{
		...
		public static UInt64 Compute(String s, UInt64 crc = 0)
		{
			return Compute(System.Text.Encoding.UTF8.GetBytes(s), crc);
		}

		public static UInt64 Compute(object SerializableObject, UInt64 crc = 0)
		{
			//BinaryFormatter bf = new BinaryFormatter();
			//MemoryStream ms = new MemoryStream();
			//bf.Serialize(ms, SerializableObject);
			String obj = JsonConvert.SerializeObject(SerializableObject);
			return Compute(obj, crc);
		}
